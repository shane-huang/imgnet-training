...
function M.parse(arg)
    ...
    cmd:option('-minLR',        0.1, 'min learing rate for cyclic learning rate policies')
    cmd:option('-maxLR',        1, 'max learning rate for cyclic learning rate policies')
    cmd:option('-startLrPolicy',1, 'the epoch where cyclic learning rate starts')
    cmd:option('-stepSize',     10000,'step size for cyclic learning rate policies')
    cmd:option('-CLR',          'none','the cyclic learning rate policy')
